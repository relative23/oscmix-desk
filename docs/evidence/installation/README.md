...
This is the original installation-branch qualification, including its VM
experiment. The later [combined 0.7.2 development record](../0.7.2/installation.json)
repeats the eleven container targets with the playback-mode changes. It
does not relabel this earlier VM run as a test of the newer runtime.
