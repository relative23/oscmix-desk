# Roadmap through 0.7.0

> Historical snapshot of `docs/ROADMAP.md` at `cd7e521`, archived on
> 2026-09-22. It includes superseded drafts, comparisons and open-item
> claims; it is not the current support or release plan. Only this
> heading, this notice and relative links have changed. See the
> [current roadmap](../ROADMAP.md) for the reconciled status.
